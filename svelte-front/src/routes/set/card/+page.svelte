<script lang="ts">
  // First number is how the number
  ...
  let shape = ["#diamond", "#squiggle", "#pill"];
</script>

<div class="helpers">
  <div class="shapes">
    <svg id="strip" viewBox="0 0 8 12" stroke-width="0.3" stroke="black">
    ...
    <svg id="pill" viewBox="0 0 8 12" stroke-width="0.3">
      <path
